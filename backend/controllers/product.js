...
export const createProduct = async (req, res, next) => {
    const { name, price, details } = req.body; // Extract the 'name' property from the request body
    // const {frontPhoto, backPhoto} = req.file.filename; // Assuming you're using multer to upload files

product.create({ name, price, details/*, frontPhoto, backPhoto*/ })
        .then((data) => {
